...
const HEADERED_PLAYLIST_DESKTOP_ROW_HEIGHT = 88
const HEADERED_PLAYLIST_COMPACT_ROW_HEIGHT = 86
...
function useHeaderedPlaylistScroll(
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      appShell.style.setProperty('--immersive-topbar-filter', `blur(${topbarBlur}) saturate(${100 + Math.round(50 * collapseProgress)}%)`)
    ...
    return () => {
      ...
      appShell.style.removeProperty('--immersive-topbar-filter')
