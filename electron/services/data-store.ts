...
export class SmplayerDataStore {
  ...
  getSettingsSnapshot(): SettingsSnapshot {
    ...
    return {
      ...
      localViewMode: this.mapLocalViewMode(settings.LocalViewMode),
  ...
  updateSettings(update: AppSettingsUpdate) {
    ...
    this.updateAppSettingsStatement.run(
      ...
      this.toLocalViewModeValue(update.localViewMode ?? this.mapLocalViewMode(settings.LocalViewMode)),
  ...
  private mapLocalViewMode(modeValue: number): LocalViewMode {
    return modeValue === 1 ? 'list' : 'grid'
  }

  private toLocalViewModeValue(mode: LocalViewMode) {
